...
/**
 * The main class that parses user and/or inputs.
 */
public class Main {
    ...
    /**
     * Main method for the program. Parses user and/or file inputs.
     * @param args file inputs for this method to parse
     */
    public static void main(String[] args) {
        ...
        while (!in.equals("quit")) {
            ...
            switch (command[0]) {
                ...
                case "seed":
                    try {
                        if (command.length != 2) throw new Exception();
                ...
                case "stats":
                    try {
                        ...
                        switch (command[1]) {
                            case "Entity":
                                Entity.runStats(Entity.getInstances("Entity"));
                                break;

                            case "PowerCell":
                                PowerCell.runStats(Entity.getInstances("PowerCell"));
                                break;

                            case "MaintenanceBot":
                                MaintenanceBot.runStats(Entity.getInstances("MaintenanceBot"));
                                break;

                            case "Engineer":
                                Engineer.runStats(Entity.getInstances("Engineer"));
                                break;

                            case "Commander":
                                Commander.runStats(Entity.getInstances("Commander"));
                                break;
